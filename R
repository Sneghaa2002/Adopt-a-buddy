...
#dbExecute(con, 'CREATE TABLE adopt_a_buddy(pet_id varchar(20),pet_breed varchar(20),colour_type varchar(10),height int,weight int,length int,months_of_stay int);')
...
")),    mainPanel(
  ...
  tabPanel("FEEDBACK",fluid = TRUE,titlePanel("FEEDBACK FORM :"),
           numericInput("rating", "RATE US :",value=0,min = 1, max = 5),

           textAreaInput("feedback", "FEEDBACK :", rows = 3),fluidRow(
             actionButton("submit", "SUBMIT", class = "btn-lg btn-success"))),
